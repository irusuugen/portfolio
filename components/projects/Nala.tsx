    ...
    <div className="relative w-full h-full bg-background text-primary flex flex-col overflow-y-auto">
      ...
      <div className="text-justify w-full max-w-7xl mx-auto px-8 md:px-16 py-20">
        ...
        <p className="text-base opacity-80">
          <i>3rd Place in Reimagine Learning Analytics Hackathon 2025</i>
        </p>
        <div className="flex flex-wrap gap-2 mt-4 mb-12">
          {["React", "Python", "Django", "Gemini API", "MySQL"].map((tech) => (
            <span
              key={tech}
        ...
        <p className="mb-12">
          NALA Learnscape builds on NTU's educational NALA chatbot, adding on an
          AI-powered study scheduler, a learning prefence profiler, interactive
          concept maps, AI-summarised notes, and customisable quizzes, aiming to
          make learning more engaging and personalised for NTU students across
          schools.
        </p>

        <h2 className="md:text-5xl text-4xl mb-2">Conference Poster</h2>
        <p className="mb-2">Presented at AI For Education Conference 2025</p>
        <Image
          src="/nalaposter.png"
          alt="NALA Learnscape Conference Poster"
          width={800}
          height={800}
        />
      </div>
